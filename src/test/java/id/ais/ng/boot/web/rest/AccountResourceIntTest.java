package id.ais.ng.boot.web.rest;

import id.ais.ng.boot.CrudNgBootApp;
import id.ais.ng.boot.config.Constants;
import id.ais.ng.boot.domain.Authority;
import id.ais.ng.boot.domain.User;
import id.ais.ng.boot.repository.AuthorityRepository;
import id.ais.ng.boot.repository.UserRepository;
import id.ais.ng.boot.security.AuthoritiesConstants;
import id.ais.ng.boot.service.MailService;
import id.ais.ng.boot.service.UserService;
import id.ais.ng.boot.service.dto.PasswordChangeDTO;
import id.ais.ng.boot.service.dto.UserDTO;
import id.ais.ng.boot.web.rest.errors.ExceptionTranslator;
import id.ais.ng.boot.web.rest.vm.KeyAndPasswordVM;
import id.ais.ng.boot.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = CrudNgBootApp.class)
