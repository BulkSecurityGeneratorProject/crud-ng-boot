package id.ais.ng.boot.repository;

import id.ais.ng.boot.CrudNgBootApp;
import id.ais.ng.boot.config.Constants;
import id.ais.ng.boot.config.audit.AuditEventConverter;
import id.ais.ng.boot.domain.PersistentAuditEvent;
...
import static id.ais.ng.boot.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
